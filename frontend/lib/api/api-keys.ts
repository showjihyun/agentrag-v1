...
export const SUPPORTED_SERVICES = [
  ...
  },
  {
    ...
    color: '#39594D',
    category: 'ai',
    description: 'Access Cohere language models',
  ...
  // Database & Storage
  {
    ...
    getKeyUrl: 'https://app.pinecone.io/',
  },
  {
    name: 'supabase',
    ...
    getKeyUrl: 'https://app.supabase.com/',
  },
  // Developer Tools
  {
    name: 'github',
...
export type ServiceCategory = 'ai' | 'search' | 'data' | 'communication' | 'database' | 'developer';

export function getServicesByCategory(category: ServiceCategory) {
  return SUPPORTED_SERVICES.filter(s => s.category === category);
}
